...
export default function Navbar({ bidderId, balance }) {
  ...
  return (
    ...
    >
      <motion.div
        className={`max-w-screen-xl  flex flex-grow items-center space-between w-full
       mx-auto  h-full px-4 md:px-0`}
      >
        <Link
          reloadDocument
          to={"/"}
        ...
        <div className="flex gap-3">
          <div className="flex items-center  group relative">
            <button
              type="button"
              className="flex text-sm bg-gray-800 relative rounded-full md:mr-0
              focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 p-1.5"
              aria-expanded="false"
            ...
            >
              ...
              <Avatar name={bidderId} variant="beam" />
            </button>
            <AnimatePresence>
              {isOpen && (
                <UserMenu
          ...
          <DarkThemeToggle className="p-1.5" />
        </div>
      </motion.div>
    </nav>
  )
