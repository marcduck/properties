  ...
  return (
    <div className="">
      ...
      <aside
        ...
        className=" shadow-slate-400/20 shadow-lg border-t fixed mt-[3.5rem] top-0 left-0 z-20 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          >
            ...
            <p className="mb-3 text-sm text-blue-800 dark:text-blue-400">
              ...
              You can turn the new navigation off for a
