...
export default function Hero() {
  return (
    <section className="">
      <div
        className="mt-2 px-4 mx-auto pt-8 md:min-h-[30rem] max-w-screen-xl 
      ...
      >
        ...
        <p className="mb-8 text-sm md:text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
          ...
          bid on your favorite properties with our intuitive
          web-based platform. Bid on properties that catch
          your eye and keep track of your bidding activity
          in real-time.
        </p>
      </div>
